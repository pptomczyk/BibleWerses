...
ksiegi = {
    ...
    45:"List do Rzymian",
    46:"I List do Koryntian",
    47:"II List do Koryntian",
    48:"List do Galatów",
    49:"List do Efezjan",
    50:"List do Filipian",
    51:"List do Kolosan",
    52:"I List do Tesaloniczan",
    53:"II List do Tesaloniczan",
    54:"I List do Tymoteusza",
    55:"II List do Tymoteusza",
    56:"List do Tytusa",
    57:"List do Filemona",
    ...
    64:"III List Jana",
    65:"List Judy",
    66:"Księga Objawienia",
}
books = ['Ks. Rodzaju', 'Ks. Wyjścia', 'Ks. Kapłańska', 'Ks. Liczb', 'Ks. Powt. Prawa', 'Ks. Jozuego', 'Ks. Sędziów', 'Ks. Rut', 'I Ks. Samuela', 'II Ks. Samuela', 'I Ks. Królewska', 'II Ks. Królewska', 'I Ks. Kronik', 'II Ks. Kronik', 'Ks. Ezdrasza', 'Ks. Nehemiasza', 'Ks. Estery', 'Ks. Hioba', 'Ks. Psalmów', 'Ks. Przysłów', 'Ks. Kaznodziei', 'Pieśń nad Pieśniami', 'Ks. Izajasza', 'Ks. Jeremiasza', 'Lamentacje', 'Ks. Ezechiela', 'Ks. Daniela', 'Ks. Ozeasza', 'Ks. Joela', 'Ks. Amosa', 'Ks. Abdiasza', 'Ks. Jonasza', 'Ks. Micheasza', 'Ks. Nahuma', 'Ks. Habakuka', 'Ks. Sofoniasza', 'Ks. Aggeusza', 'Ks. Zachariasza', 'Ks. Malachiasza', 'Ew. Mateusza', 'Ew. Marka', 'Ew. Łukasza', 'Ew. Jana', 'Dzieje Apostolskie', 'List do Rzymian', 'I List do Koryntian', 'II List do Koryntian', 'List do Galatów', 'List do Efezjan', 'List do Filipian', 'List do Kolosan', 'I List do Tesaloniczan', 'II List do Tesaloniczan', 'I List do Tymoteusza', 'II List do Tymoteusza', 'List do Tytusa', 'List do Filemona', 'List do Hebrajczyków', 'List Jakuba', 'I List Piotra', 'II List Piotra', 'I List Jana', 'II List Jana', 'III List Jana', 'List Judy', 'Księga Objawienia']
